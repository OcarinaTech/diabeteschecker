...
def testAda(dataSet, setName):
    ...
    plt.savefig('./images/ada_pruning_analysis_'+setName+'.png', bbox_inches='tight')
    #plt.show()
    plt.clf()
    ...
    plt.savefig('./images/ada_max_depth_analysis_'+setName+'.png', bbox_inches='tight')
    #plt.show()
    plt.clf()
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig('./images/ada_max_depth_analysis_cv_'+setName+'.png', bbox_inches='tight')
    plt.clf()
